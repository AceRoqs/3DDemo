...
struct bezier_patch
{
    const Vector3f* control_point_vertices;
...
std::vector<Vector3f> generate_quadratic_bezier_quads(const bezier_patch& patch, unsigned int patch_count)
{
...
// Vertices is a two dimensional array of patch vertices.
