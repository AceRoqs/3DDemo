...
void draw_list(const Map& map, const std::vector<Vector3f>& vertices, const std::vector<Vector3f>& vertices2, unsigned int patch_count, const Emitter& emitter, const Camera& camera);
